...
import {setTableName, setDefaults, createTable} from './AddExistingViewActions';

class AddExistingView extends Component {
  componentWillMount() {
  ...
  render() {
    ...
    return (
      <div className={styles.container + ' container-fluid'}>
        <Helmet title="Add Existing View - Data | Hasura" />
        <div className={styles.header}>
          <h2>Add an existing view</h2>
...
const mapStateToProps = (state) => {
  return {...state.addTable.existingView};
};

export default connect(mapStateToProps)(AddExistingView);
